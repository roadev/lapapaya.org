...
class WikisControllerTest < ActionController::TestCase
  ...
  test "should create wiki" do
    assert_difference('Wiki.count') do
      post :create, wiki: { abstract: @wiki.abstract, content: @wiki.content, tags: @wiki.tags, title: @wiki.title }
    end
  ...
  test "should update wiki" do
    patch :update, id: @wiki, wiki: { abstract: @wiki.abstract, content: @wiki.content, tags: @wiki.tags, title: @wiki.title }
    assert_redirected_to wiki_path(assigns(:wiki))
  end
